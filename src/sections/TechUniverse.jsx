...
import { Code2, Layers, Cpu, Server, Database, Cloud, Wrench, Shield, Zap } from 'lucide-react';
...
export default function TechUniverse() {
  ...
  return (
    <section id="stack" className="py-24 bg-[#040d0a] border-t border-slate-900 font-mono-tech relative select-text">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-slate-400 text-xs sm:text-sm font-sans">
            Structured skill ecosystem spanning Full-Stack, AI/ML, Cryptography, BLE Mesh, and Embedded ESP32 IoT.
          </p>
        </div>
          ...
          {skillsCategories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2.5 rounded-xl border text-xs font-bold transition-all cursor-pointer ${
                  isSelected
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-mono-tech font-bold text-emerald-400">{skill.level}%</span>
                  </div>
                  ...
                  <p className="text-[10px] text-slate-400 line-clamp-2 font-sans">{skill.useCase}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="os-glass-panel rounded-2xl border border-emerald-500/30 p-6 shadow-2xl space-y-6 sticky top-28">
              <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                <div>
                  <span className="text-[10px] text-emerald-400 font-bold uppercase tracking-widest block">SKILL INSPECTOR</span>
                  <h3 className="font-sans text-xl font-bold text-slate-100">{selectedSkill.name}</h3>
                </div>
                <div className="text-xs font-bold text-emerald-300 bg-emerald-950/80 px-3 py-1 rounded-full border border-emerald-500/30">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 bg-slate-900/80 p-3.5 rounded-xl border border-slate-800 leading-relaxed font-sans">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedSkill.projects.map((proj) => (
                    <span key={proj} className="text-xs bg-emerald-950/80 text-emerald-300 px-3 py-1 rounded-lg border border-emerald-500/30 font-bold">
                      {proj}
                    </span>
                  ))}
                </div>
