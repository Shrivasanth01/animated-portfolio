...
export default function Hero({ onLaunchApp }) {
  ...
  return (
    <section id="hero" className="relative min-h-screen pt-28 pb-20 flex items-center bg-grid-pattern bg-radial-glow overflow-hidden select-text">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-emerald-500/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-72 h-72 bg-cyan-600/15 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="inline-flex items-center space-x-3 px-3.5 py-1.5 os-glass-panel rounded-full border border-emerald-500/30 bg-emerald-950/30 font-mono-tech text-xs">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4 font-mono-tech">
              <button
                ...
                className="px-6 py-3.5 bg-emerald-400 hover:bg-emerald-500 text-slate-950 font-bold rounded-xl shadow-[0_0_25px_rgba(16,185,129,0.4)] hover:shadow-[0_0_35px_rgba(16,185,129,0.7)] transition-all flex items-center space-x-2 cursor-pointer text-xs tracking-wider"
                data-cursor="WORK"
              >
              ...
              <button
                ...
                className="px-6 py-3.5 os-glass-panel hover:bg-slate-800/80 text-slate-200 font-bold rounded-xl border border-white/10 hover:border-emerald-500/40 transition-all flex items-center space-x-2 cursor-pointer text-xs tracking-wider"
                data-cursor="CONNECT"
              >
          ...
          <div className="lg:col-span-5">
            <div className="os-glass-panel rounded-2xl border border-emerald-500/30 p-6 shadow-2xl relative overflow-hidden font-mono-tech space-y-6">
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-[10px] font-bold text-emerald-300 bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-500/30 flex items-center space-x-1">
